...
const LinkToDonationModal = () => {
  return (
    <View style={{width: "100%", height: 200, justifyContent :"center", alignItems : 'center',shadowColor: "black", shadowOffset: { width: 0, height: 0},shadowOpacity: 0.6, borderRadius : 20 }} >
    <Link href={'more/Donation'} asChild>
        <ImageBackground 
            source={require('@/assets/images/MASDonation.png')}
            style={{ width: '95%', height : '100%', borderRadius : 20, alignSelf : 'center'}}
            imageStyle={{ width : '100%', height : '100%', borderRadius : 20, alignSelf : 'center', objectFit : 'fill'}}
        />
