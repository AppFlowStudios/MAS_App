...
const Marquee = ({ duration = 30000, reverse = false, children, style }) => {
...
function IconsMarquee() {
  ...
  const MasjidPlatforms : { platform : any, link : string, name : string, bg: string }[]= [
    ...
    { platform : <WhatsApp />, link: 'https://whatsapp.com', name : 'WhatsApp', bg : '#00E676' },
          ...
          <View className='flex flex-row gap-8'>
            {
                MasjidPlatforms.map((item) => {
                    ...
                    <Pressable className='flex-col flex' onPress={onPress}>
                        <View
                        className=' w-[100] h-[100] rounded-full items-center  justify-center p-2 bg-gradient-to-br from-[#7D09FF] via-[#FF3E09] to-[#B9244E] '
