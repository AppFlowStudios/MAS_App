  ...
  return (
    <View className='flex-col p-2 w-[100%] gap-1'>
        <Pressable onPress={onPress} className='w-[100%] justify-between flex-row'>
            ...
            <Text className='text-gray-400 text-left border self-start text-[15px]'>Kids Programs: </Text>
            <FlatList 
                data={Kids}
                renderItem={({item}) => (
                ...
                horizontal
            />
            <Text className='text-gray-400 mt-4 mb-4 self-start text-[15px]'>Programs: </Text>
            <FlatList 
                data={Programs}
                renderItem={({item}) => (
                    <Link href={`/menu/program/${item.program_id}`} asChild>
                ...
                horizontal
            />
            <Text className='text-gray-400 mt-4 mb-4 self-start text-[15px]'>Events: </Text>
            <FlatList 
                data={Events}
                renderItem={({item}) => (
                ...
                horizontal
            />
            <Text className='text-gray-400 mt-4 mb-4 self-start text-[15px]'>Pace:</Text>
            <FlatList 
                data={Pace}
                renderItem={({item}) => (
                    <Link href={`/menu/program/events/${item.event_id}`} asChild>
